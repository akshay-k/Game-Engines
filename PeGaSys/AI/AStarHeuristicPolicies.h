...
public:
  ...
  inline double Vec2DDistance(const Math3D::Vector4 &v1, const Math3D::Vector4 &v2)
  {

	  double ySeparation = v2.getY()/*.y*/ - v1.getY()/*.y*/;
	  double xSeparation = v2.getX()/*.x*/ - v1.getX()/*.x*/;
