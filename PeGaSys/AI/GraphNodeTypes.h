...
public:
  ...
  NavGraphNode(int      idx,
	  Math3D::Vector4 pos):GraphNode(idx),
                             m_vPosition(pos),
  ...
  Math3D::Vector4   Pos()const{return m_vPosition;}
  void       SetPos(Math3D::Vector4 NewPosition){m_vPosition = NewPosition;}
